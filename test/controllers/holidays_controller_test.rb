...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { city_id: @holiday.city_id, date: @holiday.date } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { city_id: @holiday.city_id, date: @holiday.date } }
