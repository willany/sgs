class SpecialtiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @specialty.save
        format.html { redirect_to @specialty, flash: { success: "Especialidade criada com sucesso!" } }
  ...
  def update
    respond_to do |format|
      if @specialty.update(specialty_params)
        format.html { redirect_to @specialty, flash: { success: "Especialidade alterada com sucesso!" } }
  ...
  def destroy
    @specialty.destroy
    respond_to do |format|
      format.html { redirect_to specialties_url, flash: { success: "Especialidade apagada com sucesso!" } }
